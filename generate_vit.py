...
from datasets.crowd_vit import Crowd_qnrf, Crowd_nwpu, Crowd_sh
from models import vitb16 ,MLP
...
class Trainer(object):
    ...
    def setup(self):
        ...
        log_utils.set_value("this", "vitb1e-5")
    ...
    def train_eopch(self):
        ...
        for step, (inputs, points, gt_discrete, names) in enumerate(self.dataloaders['train']):
            ...
            with torch.set_grad_enabled(True):
                ...
                B, T = outputs.shape
                outputs = outputs.reshape(B,1,self.outputshape,self.outputshape)
                outputs_normed = outputs_normed.reshape(B,1,self.outputshape,self.outputshape)
...
def parse_args():
    ...
    parser.add_argument('--val-start', type=int, default=2,
