...
args = {
    ...
    "resume" : None,
    "convexify_iter" : 1,
    "train_notes": "Train icnn 3*1024, add zero-mean, add convexfy_iter, add strong-convexity"
}
args = Munch(args)
...
pred_net = OriDenseICNN(in_dim=2*1000, hidden_layer_sizes=[1024,1024,1024], rank=1, activation='leakyrelu',  strong_convexity=1e-2,device = device).to(device).double()
